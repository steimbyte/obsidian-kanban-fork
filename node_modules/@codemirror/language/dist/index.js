import { NodeProp, Tree, TreeFragment, Parser, IterMode, NodeType, NodeSet } from '@lezer/common';
import { StateEffect, StateField, Facet, EditorState, countColumn, combineConfig, RangeSetBuilder, RangeSet, Prec } from '@codemirror/state';
...
const tokenClassNodeProp = /*@__PURE__*/new NodeProp();
const lineClassNodeProp = /*@__PURE__*/new NodeProp();
...
const lineHighlighter = /*@__PURE__*/Prec.lowest(/*@__PURE__*/ViewPlugin.define(view => new LineHighlighter(view), {
    decorations: v => v.decorations
}));
const ignoreSpellcheckToken = /*@__PURE__*/Facet.define({});
